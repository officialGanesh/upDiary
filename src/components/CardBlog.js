...
function CardBlog() {
  return (
    <>
    <main className="flex flex-col justify-center items-center my-32">
      <div className="p-6 max-w-2xl bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mb-5">
        <div>
